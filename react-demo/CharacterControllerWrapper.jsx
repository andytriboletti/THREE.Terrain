...
// A wrapper component that handles the character controller
const CharacterControllerWrapper = forwardRef(({ position = [0, 5, 0], jumpVel = 5, moveSpeed = 5 }, ref) => {
...
export default CharacterControllerWrapper;
